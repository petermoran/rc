...
let g:colors_name = 'peterdark'

" Functions {{{
function! s:generate_base_colors(base1)
  let b1 = s:RGB2HSL(s:hex2RGB(a:base1))
  let b2 = [b1[0], b1[1], b1[2]+5]
  let b3 = [b1[0], b1[1], b2[2]+15]
  let b4 = [b1[0], b1[1], b3[2]+25]
  let b5 = [b1[0], b1[1], b4[2]+35]
  return [a:base1,
...
if !exists('g:peterdark#italics')
  let g:peterdark#italics = 0
endif

if !exists('g:peterdark#background')
  let g:peterdark#background = ''
endif

if !exists('g:peterdark#terminal_transparent')
  let g:peterdark#terminal_transparent = 0
endif

if !exists('g:peterdark#solid_vertsplit')
  let g:peterdark#solid_vertsplit = 0
endif

if g:peterdark#background == ''
  let bases = s:generate_base_colors('#2c2c2c')
else
  let bases = s:generate_base_colors(g:peterdark#background)
endif
...
let s:red        = ['#da5c84', 168]
let s:green      = ['#b5cc79', 108]
let s:yellow     = ['#e7c085', 179]
let s:blue       = ['#71baf9', 74]
let s:purple     = ['#b888e2', 140]
let s:orange     = ['#ba7d1a', 173]
let s:pink       = ['#c464a3', 181]
let s:teal       = ['#54d1bf', 73]
let s:beige      = ['#c7c18b', 180]
let s:light_blue = ['#89d3e8', 80]
let s:brown      = ['#c2948d', 138]

" Transparent Background
if g:peterdark#terminal_transparent == 1
...
function! s:hi(group, fg, bg, attr)
  let l:attr = a:attr
  if g:peterdark#italics == 0 && l:attr ==? 'italic'
    let l:attr = 'none'
  endif
...
if g:peterdark#solid_vertsplit == 1
