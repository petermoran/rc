...
-- beautiful.init("/home/peter.moran/.config/awesome/themes/zenburn/theme.lua")
...
globalkeys = awful.util.table.join(
    ...
    awful.key({ modkey,           }, "o", function () awful.screen.focus_relative( 2) end),
    awful.key({ modkey,           }, "y", function () awful.screen.focus_relative(-2) end),
...
awful.util.spawn_with_shell("run_once unity-settings-daemon")
